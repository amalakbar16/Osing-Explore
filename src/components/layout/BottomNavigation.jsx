      ...
      <div className="flex justify-around items-center h-16 px-2 max-w-md mx-auto">
        {navItems.map((item) => (
          <NavLink
            ...
            to={item.path}
            className={({ isActive }) => 
              `relative flex flex-col items-center justify-center w-16 h-full transition-colors duration-250 ease-in-out ${
          ...
          >
            {({ isActive }) => (
              <>
                <item.icon size={24} strokeWidth={isActive ? 2 : 1.5} className="mb-1" />
