...
import { Mountain, Flame, Palette } from 'lucide-react';
...
export default function KategoriFilter({ activeKategori, onSelect }: KategoriFilterProps) {
  const categories = [
    { id: 'semua', label: 'Semua', icon: undefined },
