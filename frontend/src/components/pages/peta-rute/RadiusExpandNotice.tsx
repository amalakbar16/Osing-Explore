...
interface RadiusExpandNoticeProps {
  isExpanded: boolean;
  originalRadius: number;
  newRadius: number;
}

export default function RadiusExpandNotice({
  isExpanded,
  originalRadius,
  newRadius,
}: RadiusExpandNoticeProps) {
  if (!isExpanded) return null;

  return (
    <div className="mx-6 mt-4 p-3 bg-accent-primary/10 border border-accent-primary/20 rounded-lg flex gap-3 items-start animate-fade-in">
